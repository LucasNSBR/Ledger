        ...
        public FakeActivationRepository()
        {
            _activations = new List<Activation>()
            {
                ...
                new Activation(
                    ...
                    new Owner("Pedro Henrique Pereira Campos", DateTime.Now.AddYears(-12), new Cpf("150.992.359-00")))
                    ),
                new Activation(
                    new Company(new Guid("9c0e0aa4-2618-4158-9714-dee8dd94b5ad"),
                    new Owner("Otacilio Rocha Campos", DateTime.Now.AddYears(-40), new Cpf("515.110.991-05")))
                    ),
            };
        }
